...
mtcars
#command shift m is the one after mtcars
mtcars <- mtcars |>
  rownames_to_column("model")

View(mtcars)
head(mtcars,10) #preview 
summary(mtcars)
?mtcars #opens help info in the bottom right window 

tail(mtcars,5)
mean(mtcars$mpg) # $ lets u select a variable/column in a dataframe
...
#anything below we'llw work on later
mtcars <- mtcars |> 
