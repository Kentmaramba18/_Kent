...
```{r, message=FALSE}
ggplot(penguins_data), aes(x= flipper_length_mm, fill = species)) +
    geom_boxplot()
...
ggplot(penguins_data), aes(x= flipper_length_mm, fill = species , shape = island)) +
    geom_point() +
    scal
...
ggplot(penguins_data), aes(x= flipper_length_mm, fill = species)) +
    ...
    scale_fill_viridis_d(option="mako") +
                        ...
                        labs(title = "palmer penguins' flipper Length",
                             subtitle = "three species obsrved on the three islands in the Palmer Archipelago", x = "flipper length(mm)", y = "Number of Penguins")
  ggplotly(plotname)
